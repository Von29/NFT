(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".main-trending__slider--animals")) {
            let thumbsSwiper = new core(".preview-trending__slider--animals", {
            ...
            new core(".main-trending__slider--animals", {
                modules: [ Navigation, Autoplay, Thumb, Controller, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 0,
        ...
        if (document.querySelector(".main-trending__slider--mushrooms")) {
            let thumbsSwiper = new core(".preview-trending__slider--mushrooms", {
                modules: [ Navigation, Thumb, Controller, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            new core(".main-trending__slider--mushrooms", {
                modules: [ Navigation, Autoplay, Thumb, Controller, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (document.querySelector(".main-trending__slider--robots")) {
            let thumbsSwiper = new core(".preview-trending__slider--robots", {
                modules: [ Navigation, Thumb, Controller, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            new core(".main-trending__slider--robots", {
                modules: [ Navigation, Autoplay, Thumb, Controller, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (document.querySelector(".main-trending__slider--animals-2")) {
            let thumbsSwiper = new core(".preview-trending__slider--animals-2", {
                modules: [ Navigation, Thumb, Controller, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            new core(".main-trending__slider--animals-2", {
                modules: [ Navigation, Autoplay, Thumb, Controller, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
